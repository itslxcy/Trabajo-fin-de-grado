...
('Ratón Bluetooth', 'Ratón inalámbrico ergonómico.', false, 2, true, true, 'https://goo.su/3XvwDat'),
...
WHERE nombre IN ('Grid 3', 'Verbo', 'TD Snap', 'ComuniQa (TD Snap)', 'ComuniQa (Grid 3)', 'Communicator 5', 'TD Pilot', 'Predictable', 'EVA Facial Mouse', 'Hub Infrarrojos (Broadlink/Logitech)', 'Enchufe Inteligente WiFi');

INSERT INTO sistema_requisito_funcional (sistema_id, nivel_visual_min, nivel_auditivo_min, nivel_cognitivo_min, nivel_tecnologico_min, nivel_habla_min)
SELECT id, 1, 1, 2, 2, 3 FROM saac_sistema WHERE nombre = 'Amazon Alexa / Google Home';
...
WHERE nombre IN ('Panel pictogramas', 'Panel alfabético', 'SpeakBook', 'Puntero Láser', 'Asistente de voz AAC', 'Proloquo2Go', 'Grid 3', 'Verbo', 'Boardmaker 7', 'QuickTalker 23', 'LetMeTalk', 'TD Snap', 'Guantes antiincrustantes', 'Lápiz táctil', 'Ratón Bluetooth', 'Predictable', 'VirtualTEC', 'Ease Touch', 'iPad (Apple)', 'Tablet Android (Gama Media/Alta)', 'Ordenador Portátil (Windows)', 'Hub Infrarrojos (Broadlink/Logitech)', 'Enchufe Inteligente WiFi');

INSERT INTO sistema_entrada (sistema_id, entrada_id)
SELECT id, (SELECT id FROM tipo_entrada WHERE nombre = 'ojos') FROM saac_sistema 
WHERE nombre IN ('Look to Speak', 'Eye tracker', 'Tablero ETRAN', 'Tallk', 'Look to learn', 'Grid 3', 'ComuniQa (TD Snap)', 'ComuniQa (Grid 3)', 'TD Pilot', 'Communicator 5', 'MegaBEE', 'OptiKey', 'Ordenador Portátil (Windows)', 'Hub Infrarrojos (Broadlink/Logitech)');
...
WHERE nombre IN ('Amazon Alexa / Google Home', 'Asistente de voz AAC');
...
WHERE nombre IN ('Grid 3', 'Eye tracker', 'Verbo', 'Look to learn', 'TD Snap', 'Communicator 5', 'Boardmaker 7', 'OptiKey', 'Ordenador Portátil (Windows)', 'Hub Infrarrojos (Broadlink/Logitech)');
