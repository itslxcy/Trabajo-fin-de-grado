...
\begin{itemize}
	...
	\imagen{../img/caso_real_1_copia.png}{Recomendaciones y feedback al primer caso de paciente real.}{1}
	...
	\imagen{../img/caso_real_2_copia.png}{Recomendaciones y feedback al segundo caso de paciente real.}{1}
...
\begin{itemize}
	...
	\imagen{../img/caso_prueba_1_copia.png}{Recomendación al primer caso de paciente simulado.}{1}
	Debe especificarse además que, aunque no quede registrado este hecho en la base de datos, al paciente también se le recomendó comenzar de forma preventiva un proceso de voice banking, ya que cuenta con su habla totalmente preservada.
	\imagen{../img/voice_banking.png}{Sugerencia de voice banking preventivo.}{1}
	Es importante además destacar que, siempre que se recomienden sistemas de alta tecnología aparecerá por pantalla un recordatorio de la importancia de contar con un plan de respaldo.
	\imagen{../img/plan_respaldo.png}{Plan de respaldo.}{1}
	...
	\imagen{../img/caso_prueba_2_copia.png}{Recomendación al segundo caso de paciente simulado.}{1}
	...
	\imagen{../img/caso_prueba_3_copia.png}{Recomendación al tercer caso de paciente simulado.}{1}
	...
	\imagen{../img/caso_prueba_4_copia.png}{Recomendación al cuarto caso de paciente simulado.}{1}

	Además, se muestra a continuación el mensaje que le saldría por pantalla al paciente:
	\imagen{../img/sin_resultados.png}{Mensaje sin resultados.}{1}

	\item \textbf{Caso de prueba 5: PAC-I0BNNZ (Uso preventivo)} Este último caso de prueba se realizó con intención de comprobar la correcta recomendación de uso preventivo de sistemas con seguimiento ocular. Este tipo de SAAC son los que tienen una curva de aprendizaje más 			pronunciada, los expertos recomiendan empezar a entrenar y familiarizarse con ellos de forma temprana, por eso se recomiendan cuando el paciente conserva buena visión (Nivel 3) y resistencia a fatiga (Nivel 3) y no ha seleccionado los ojos como un método de acceso.
	\imagen{../img/caso_prueba_5.png}{Quinto caso de paciente simulado.}{1}
	\imagen{../img/caso_prueba_5_copia.png}{Recomendación al quinto caso de paciente simulado.}{1}
	\imagen{../img/uso_preventivo.png}{Recomendación preventiva.}{1}
\end{itemize}

\section{Enlace a resultados}
El seguimiento del proyecto puede observarse a través del Github \url{https://github.com/itslxcy/Trabajo-fin-de-grado.git}.
En cuanto a la página web con cuestionario diseñada puede consultarse en el siguiente enlace \url{https://cuestionario-tfg.onrender.com/}
