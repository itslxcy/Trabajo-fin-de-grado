...
La Esclerosis Lateral Amiotrófica (ELA) es una enfermedad neurodegenerativa progresiva que afecta a la capacidad motora y, en fases avanzadas, a la comunicación oral de las personas que la padecen \cite{startstemcells:als}. A medida que la enfermedad progresa, muchos pacientes experimentan una pérdida parcial o total del habla, lo que dificulta la interacción con su entorno y tiene un impacto directo en su autonomía, calidad de vida y bienestar emocional.
...
Este trabajo se enmarca dentro del ámbito de la Ingeniería de la Salud y aborda esta problemática desde una perspectiva de apoyo a la toma de decisiones. Aunque ya existen guías que recopilan información sobre los distintos SAAC disponibles \cite{ceapat:productos, elaandalucia:guia}, estos suelen presentarse en formatos extensos y estáticos que requieren tiempo, conocimientos previos y esfuerzo por parte del usuario para extraer conclusiones. A la hora de la verdad, especialmente en el caso de enfermedades progresivas como la ELA donde el tiempo es clave, este método no es adecuado.
