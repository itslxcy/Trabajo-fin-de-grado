...
El proyecto ha sido desarrollado por una única persona en el rol de analista, diseñadora y programadora. De acuerdo con la asignación académica del Trabajo de Fin de Grado, fijada en 15 créditos ECTS, se computa una dedicación oficial de 375 horas de trabajo autónomo.
...
\begin{table}[!h]
    ...
    \begin{tabular}{ l p{4cm} r }
        ...
        \midrule
        \addlinespace
        Analista / Desarrolladora Junior & 375 h & 6.750 € \\
        \addlinespace
        \bottomrule
    \end{tabular}
...
Considerando ambas partidas, el coste total de inversión del proyecto asciende a 6.900 €, donde el 97,7\% corresponde a la partida de ingeniería de software, justificando la complejidad del motor lógico de recomendación dinámico implementado.
