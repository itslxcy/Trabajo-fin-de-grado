...
\begin{itemize}
    	\item \textbf{Origen de los datos:} La información ha sido recopilada a partir de catálogos de productos de apoyo (CEAPAT) \cite{ceapat:productos}, documentación de asociaciones de ELA (como ELA Andalucía)\break  \cite{elaandalucia:guia} y especificaciones técnicas de desarrolladores 		de software especializado (Tobii Dynavox, 	Smartbox, Qinera, Irisbond, etc.) \cite{tobiidynavox:products,qinera:caa,irisbond:soluciones}.
