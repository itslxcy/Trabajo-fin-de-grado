...
\begin{itemize}
	...
	\item \textbf{Pruebas de seguridad:} Verificación de las cabeceras de seguridad inyectadas por \texttt{Flask-Talisman} (HSTS, XSS Protection) mediante la web VirusTotal.
\end{itemize}
